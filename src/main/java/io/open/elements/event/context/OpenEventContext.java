package io.open.elements.event.context;
...
public OpenEventContext(String eventName,String eventContext,String eventType){
	this.name=eventName;
...
public void setProcessContextState(OpenEventContextState elementContextState) {
