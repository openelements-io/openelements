package io.open.elements.schema.context;
...
public OpenSchemaContext(String eventName,String eventContext,String eventType){
	this.name=eventName;
...
public void setProcessContextState(OpenSchemaContextState elementContextState) {
