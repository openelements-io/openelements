package io.open.elements.context;
...
import io.open.elements.execution.state.context.OpenStateContextResponse;
 public class OpenElementContext extends OpenContext {
private String name;
private String context;
private String type;
boolean isInitializedForEventProcessing=false;
public OpenElementContext(){
	contextFlags=new  ArrayList<OPENEVENTFLAG>();
	contextData= new HashMap<String,Object>();
}
private OpenElementContextState elementContextState;
...
public OpenElementContext(String eventName,String eventContext,String eventType){
	this.name=eventName;
...
public void setProcessContextState(OpenElementContextState elementContextState) {
